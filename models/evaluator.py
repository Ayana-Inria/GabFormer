...
class CDEvaluator():
    ...
    def _load_checkpoint(self, checkpoint_name='best_ckpt.pt'):
        ...
        if os.path.exists(os.path.join(self.checkpoint_dir, checkpoint_name)):
            ...
            checkpoint = torch.load(os.path.join(self.checkpoint_dir, checkpoint_name), map_location=self.device)
            pretrained = checkpoint['model_G_state_dict']
            # print(checkpoint['model_G_state_dict'])
            # pretrained_dict = {key.replace("module.",""): value for key, value in checkpoint['model_G_state_dict']}
    ...
    def _forward_pass(self, batch):
        ...
        # macs, params = profile(self.net_G, inputs=(img_in1, img_in2, ))
        # print('MACs : ')
        # print(macs)
        # print('PARAMs : ')
        # print(params)
